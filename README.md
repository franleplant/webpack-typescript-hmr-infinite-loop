...
│   ├── /containers/            # Page/screen wrappers and higher order components
│   ├── /client.js              # Client-side startup script
│   ├── /config.js              # Global application settings
|   ├── /server.js              # Main application routes
│   ├── /server.js              # Server-side startup script
│   └── ...                     # Other core framework modules
├── /test/                      # Unit and end-to-end tests - should follow src structure
...
Built on top of [React Starter Kit](https://www.reactstarterkit.com)
...
Currently using the following technologies:
  ...
  * [React Router 4](https://github.com/ReactTraining/react-router/tree/master/packages/react-router-dom),
  * [Jest](https://facebook.github.io/jest/),


### How to Update with RSK
